/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2010-10-13 12:38:58 -0500 (Wed, 13 Oct 2010) $
 * $Revision: 14473 $
 *
...
abstract public class Polymer {
  ...
  public void calcRasmolHydrogenBonds(Polymer polymer, BitSet bsA,
           BitSet bsB, List vHBonds, int nMaxPerResidue, int[][][] min, 
   ...
   */
  public List calculateStruts(ModelSet modelSet, Atom[] atoms, BitSet bs1, BitSet bs2,
      List vCA, float thresh, int delta, boolean allowMultiple) {
    return null;
  }

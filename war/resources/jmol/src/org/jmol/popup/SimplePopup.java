...
public class SimplePopup {
  ...
  protected List NotPDB = new ArrayList();
  protected List PDBOnly = new ArrayList();
  protected List UnitcellOnly = new ArrayList();
  protected List SingleModelOnly = new ArrayList();
  protected List FramesOnly = new ArrayList();
  protected List VibrationOnly = new ArrayList();
  protected List SymmetryOnly = new ArrayList();
  protected List SignedOnly = new ArrayList();
  protected List AppletOnly = new ArrayList();
  protected List ChargesOnly = new ArrayList();
  protected List TemperatureOnly = new ArrayList();

/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2010-12-22 12:26:50 -0600 (Wed, 22 Dec 2010) $
 * $Revision: 14875 $
 *
...
class MainPopupResourceBundle extends PopupResource {
  ...
  private static String[][] menuContents = {
      ...
      {   "popupMenu",
          "FRAMESbyModelComputedMenu configurationComputedMenu - selectMenuText viewMenu renderMenu colorMenu - surfaceMenu UNITCELLMenu - "

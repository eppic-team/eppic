...
import ch.systemsx.sybit.crkwebui.client.commons.gui.grids.data.GridColumnSettings;
...
public class GridColumnConfigGenerator
{
	 ...
	 * @param rendererFactory factory used to select renderer for the cell
	 * @param gridName name of the grid
	 * @param model model which is used for the grid
	 * @return list of created column configurations
	 */
	public static List<ColumnConfig> createColumnConfigs(GridCellRendererFactory rendererFactory,
														 String gridName,
														 BaseModel model)
	{
			...
			if (addColumn)
			{
				...
				if (columnName.equals("METHODS"))
				{
					for (SupportedMethod method : ApplicationContext.getSettings().getScoresTypes())
					{
						...
						ColumnConfig column = createColumnConfig(rendererFactory,
																 methodGridColumnSettings,
								 								 method.getName());
	 ...
	 */
	private static ColumnConfig createColumnConfig(GridCellRendererFactory rendererFactory,
												   GridColumnSettings gridColumnSettings,
												   String columnName)
	{
		...
		GridCellRenderer<BaseModel> renderer = rendererFactory.createGridCellRenderer(

...
//		}
		...
		firstStructureContainer.add(firstStructure, new RowData(1, 1));
		...
		firstStructureContainer.add(firstStructureBreakPanel, new RowData(1, 20));

		firstStructureContainer.add(firstStructureSummary, new RowData(1, 70));
		...
		firstStructureContainer.add(firstStructureScrollPanel, new RowData(1, 20));
		...
		secondStructureContainer.setLayout(new RowLayout(Orientation.VERTICAL));
		...
		secondStructureContainer.add(secondStructureBreakPanel, new RowData(1, 20));
		
		secondStructureContainer.add(secondStructureSummary, new RowData(1, 70));
		...
		secondStructureContainer.add(secondStructureScrollPanel, new RowData(1, 20));

...
//	private GridCellRenderer<BeanModel> detailsButtonRenderer;
	...
	public OverviewPanel(MainController mainController, final PDBScoreItem resultsData)
	{
...
//		History.newItem("interface" + interfaceId + "/" + resultsData.getJobId());
	...
	private List<ColumnConfig> createColumnConfig()
	{
		...
		BeanModelFactory beanModelFactory = BeanModelLookup.get().getFactory(InterfaceItem.class);
...
//		}
//		
		String columnOrder = mainController.getSettings().getGridProperties().get("results_columns");
		...
		for(String columnName : columns)
		{
			...
			String customAdd = mainController.getSettings().getGridProperties().get("results_" + columnName + "_add");
			if(customAdd != null)
			{
			...
			if(addColumn)
			{
				...
				String customVisibility = mainController.getSettings().getGridProperties().get("results_" + columnName + "_visible");
				...
				int columnWidth = 75;
				String customColumnWidth = mainController.getSettings().getGridProperties().get("results_" + columnName + "_width");
				...
				String customRenderer = mainController.getSettings().getGridProperties().get("results_" + columnName + "_renderer");
				...
				String customHeader = mainController.getSettings().getGridProperties().get("results_" + columnName + "_header");

...
{}))[j])&&C[0]===V)r=C[1];else for(;p=++e&&p&&p[b]||(r=e=0)||g.pop();)if((h?p.nodeName.toLowerCase()===s:1===p.nodeType)&&++r)if(w&&((p[F]||(p[F]={}))[j]=[V,r]),p===a)break;r-=d;return r===c||0===r%c&&0<=r/c}}},PSEUDO:function(j,a){var b,c=v.pseudos[j]||v.setFilters[j.toLowerCase()]||y.error("unsupported pseudo: "+j);return c[F]?c(a):1<c.length?(b=[j,j,"",a],v.setFilters.hasOwnProperty(j.toLowerCase())?T(function(j,b){for(var d,f=c(j,a),k=f.length;k--;)d=oa.call(j,f[k]),j[d]=!(b[d]=f[k])}):function(j){return c(j,
0,b)}):c}},pseudos:{not:T(function(j){var a=[],b=[],c=ub(j.replace(Ra,"$1"));return c[F]?T(function(j,a,b,d){d=c(j,null,d,[]);for(var f=j.length;f--;)if(b=d[f])j[f]=!(a[f]=b)}):function(j,d,f){a[0]=j;c(a,null,f,b);return!b.pop()}}),has:T(function(j){return function(a){return 0<y(j,a).length}}),contains:T(function(j){return function(a){return-1<(a.textContent||a.innerText||Va(a)).indexOf(j)}}),lang:T(function(a){rd.test(a||"")||y.error("unsupported lang: "+a);a=a.replace(da,ea).toLowerCase();return function(b){var c;
...
h.swap(a,Jd,function(){return cc(a,b,d)}):cc(a,b,d)},set:function(a,c,d){var j=d&&la(a);return ac(a,c,d?bc(a,b,d,t.boxSizing()&&"border-box"===h.css(a,"boxSizing",!1,j),j):0)}}});t.opacity||(h.cssHooks.opacity={get:function(a,b){return Gd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,f=h.isNumeric(b)?"alpha(opacity="+100*b+")":"",k=d&&d.filter||c.filter||"";c.zoom=1;if((1<=b||""===b)&&""===
...
Jmol._version||(Jmol=function(a){var m=function(a){return{header:a++,rear:a++,main:a++,image:a++,front:a++,fileOpener:a++,coverImage:a++,dialog:a++,menu:a+9E4,monitorZIndex:a+99999}},m={_version:"JSmol 14.1.11 Mar 1, 2014",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_getZOrders:m,_z:m(Jmol.z||9E3),_debugCode:!0,db:{_databasePrefixes:"$=:",_fileLoadScript:";if (_loadScript = '' && defaultLoadScript == '' && _filetype == 'Pdb') { select protein or nucleic;cartoons Only;color structure; select * };",
...
function(b,c,d,e){var k=e.length/5;if(0!=k&&4==d.length&&1!=k){d=d.toUpperCase();var r=e.indexOf(d);0<r&&0<="123456789".indexOf(d.substring(0,1))&&(e=d+","+e.substring(0,r)+e.substring(r+5));50<k&&(e=e.substring(0,250));e=e.replace(/\n/g,",");e=a._restReportUrl.replace(/IDLIST/,e);a._loadFileData(b,e,function(d){a._setInfo(b,c,d)})}};a._checkAjaxPost=function(a){var c=a.url.indexOf("?POST?");0<c&&(a.data=a.url.substring(c+6),a.url=a.url.substring(0,c),a.type="POST",a.contentType="application/x-www-form-urlencoded")};
a._contactServer=function(b,c,d){b={dataType:"text",type:"GET",url:a._serverUrl+b,success:function(b){a._loadSuccess(b,c)},error:function(){a._loadError(d)},async:c?a._asynchronous:!1};a._checkAjaxPost(b);return a._ajax(b)};a._setQueryTerm=function(b,c){if(c&&b._hasOptions&&"http://"!=c.substring(0,7)){if(a._isDatabaseCall(c)){var d=c.substring(0,1);c=c.substring(1);c.substring(0,1)==d&&0<="=$".indexOf(d)&&(c=c.substring(1));var e=a._getElement(b,"select");if(e&&e.options)for(var k=0;k<e.options.length;k++)e[k].value==
d&&(e[k].selected=!0)}a.$val(a.$(b,"query"),c)}};a._search=function(b,c,d){1<arguments.length||(c=null);a._setQueryTerm(b,c);c||(c=a.$val(a.$(b,"query")));0==c.indexOf("!")?b._script(c.substring(1)):(c&&(c=c.replace(/\"/g,"")),b._showInfo(!1),a._searchMol(b,c,d,!0))};a._searchMol=function(b,c,d,e){var k;a._isDatabaseCall(c)?(k=c.substring(0,1),c=c.substring(1)):k=b._hasOptions?a.$val(a.$(b,"select")):"$";"="==k&&3==c.length&&(c="="+c);var r=k+c;if(c&&!(0>r.indexOf("?")&&r==b._thisJmolModel)){b._thisJmolModel=
r;var g;e&&null!=b._viewSet&&null!=(g=a.View.__findView(b._viewSet,{chemID:r}))?a.View.__setView(g,b,!1):("$"==k||":"==k?b._jmolFileType="MOL":"="==k&&(b._jmolFileType="PDB"),b._searchDatabase(c,k,d))}};a._searchDatabase=function(b,c,d,e){b._showInfo(!1);return 0<=c.indexOf("?")?(a._getInfoFromDatabase(b,d,c.split("?")[0]),!0):a.db._DirectDatabaseCalls[d]?(b._loadFile(d+c,e),!0):!1};a._syncBinaryOK="?";a._canSyncBinary=function(b){if(self.VBArray)return a._syncBinaryOK=!1;if("?"!=a._syncBinaryOK)return a._syncBinaryOK;
...
a._isBinaryUrl=function(b){for(var c=a._binaryTypes.length;0<=--c;)if(0<=b.indexOf(a._binaryTypes[c]))return!0;return!1};a._getFileData=function(b,c){var d=a._isBinaryUrl(b)?"binary":"text",e=0<=b.indexOf("pdb.gz")&&0==b.indexOf("http://www.rcsb.org/pdb/files/"),k="binary"==d&&!a._canSyncBinary(e);k&&e&&(b=b.replace(/pdb\.gz/,"pdb"),k=!1,d="text");e=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&(b="file://"+b.substring(5));var r=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&
0<=b.indexOf(document.location.host),g=a._isDirectCall(b),l=!r&&a.$supportsIECrossDomainScripting();if(!c||k)if(l||k||!r&&!g)return a._getRawDataFromServer("_",b,c,c,k,!0);b=b.replace(/file:\/\/\/\//,"file://");var q={dataType:d,async:!!c};e?(q.type="POST",q.url=b.split("?POST?")[0],q.data=b.split("?POST?")[1]):(q.type="GET",q.url=b);c&&(q.success=function(){c(a._xhrReturn(q.xhr))},q.error=function(){c(xhr.statusText)});q.xhr=a.$ajax(q);if(!c)return a._xhrReturn(q.xhr)};a._xhrReturn=function(a){return!a.responseText||
...
return a.substring(0,Math.min(a.length,3))};a._getZ=function(b,c){return b&&b._z&&b._z[c]||a._z[c]};a._incrZ=function(b,c){return b&&b._z&&++b._z[c]||++a._z[c]};a._loadFileAsynchronously=function(b,c,d,e){if(0!=d.indexOf("?")){d=a._checkFileName(c,d);var k=function(c){a._setData(b,d,c,e)},k=a._checkCache(c,d,k);return null==k?null:a._getFileData(d,k)}if(!a.featureDetection.hasFileReader)return b.setData("Local file reading is not enabled in your browser",null,e);c._localReader||(k='<div id="ID" style="z-index:'+
a._getZ(c,"fileOpener")+';position:absolute;background:#E0E0E0;left:10px;top:10px"><div style="margin:5px 5px 5px 5px;"><input type="file" id="ID_files" /><button id="ID_loadfile">load</button><button id="ID_cancel">cancel</button></div><div>',a.$after("#"+c._id+"_appletdiv",k.replace(/ID/g,c._id+"_localReader")),c._localReader=a.$(c,"localReader"));a.$appEvent(c,"localReader_loadfile","click");a.$appEvent(c,"localReader_loadfile","click",function(){var d=a.$(c,"localReader_files")[0].files[0],k=
new FileReader;k.onloadend=function(k){k.target.readyState==FileReader.DONE&&(a.$css(a.$(c,"localReader"),{display:"none"}),a._setData(b,d.name,k.target.result,e))};k.readAsArrayBuffer(d)});a.$appEvent(c,"localReader_cancel","click");a.$appEvent(c,"localReader_cancel","click",function(){a.$css(a.$(c,"localReader"),{display:"none"});b.setData(null,e)});a.$css(a.$(c,"localReader"),{display:"block"})};a._setData=function(b,c,d,e){d=a._strToBytes(d);0<=c.indexOf(".jdx")&&a.Cache.put("cache://"+c,d);b.setData(c,
d,e)};a._toBytes=function(a){if("string"==typeof a)return a.getBytes();a=new Uint8Array(a);for(var c=Clazz.newByteArray(a.length,0),d=a.length;0<=--d;)c[d]=a[d];return c};a._doAjax=function(b,c,d){b=b.toString();if(null!=d)return a._saveFile(b,d);c&&(b+="?POST?"+c);c=a._getFileData(b);return a._processData(c,a._isBinaryUrl(b))};a._saveFile=function(b,c,d,e){if(a._localFileSaveFunction&&a._localFileSaveFunction(b,c))return"OK";b=b.substring(b.lastIndexOf("/")+1);d||(d=0<=b.indexOf(".pdf")?"application/pdf":
...
function(a,c){return document.getElementById(a._id+"_"+c)||{}};a._evalJSON=function(a,c){a+="";if(!a)return[];if("{"!=a.charAt(0))return 0<=a.indexOf(" | ")&&(a=a.replace(/\ \|\ /g,"\n")),a;var d=(new Function("return "+a))();return!d?null:c&&void 0!=d[c]?d[c]:d};a._sortMessages=function(a){function c(a,b){return a[0]<b[0]?1:a[0]>b[0]?-1:0}if(!a||"object"!=typeof a)return[];for(var d=[],e=a.length-1;0<=e;e--)for(var k=0,r=a[e].length;k<r;k++)d[d.length]=a[e][k];if(0!=d.length)return d=d.sort(c)};
a._setMouseOwner=function(b,c){null==b||c?a._mouseOwner=b:a._mouseOwner==b&&(a._mouseOwner=null)};a._jsGetMouseModifiers=function(a){var c=0;switch(a.button){case 0:c=16;break;case 1:c=8;break;case 2:c=4}a.shiftKey&&(c+=1);a.altKey&&(c+=8);a.ctrlKey&&(c+=2);return c};a._jsGetXY=function(b,c){if(!b.applet._ready||a._touching&&0>c.type.indexOf("touch"))return!1;c.preventDefault();var d=a.$offset(b.id),e,k=c.originalEvent;a._mousePageX=c.pageX;a._mousePageY=c.pageY;k.targetTouches&&k.targetTouches[0]?
(e=k.targetTouches[0].pageX-d.left,d=k.targetTouches[0].pageY-d.top):k.changedTouches?(e=k.changedTouches[0].pageX-d.left,d=k.changedTouches[0].pageY-d.top):(e=c.pageX-d.left,d=c.pageY-d.top);return void 0==e?null:[Math.round(e),Math.round(d),a._jsGetMouseModifiers(c)]};a._gestureUpdate=function(b,c){c.stopPropagation();c.preventDefault();var d=c.originalEvent;switch(c.type){case "touchstart":a._touching=!0;break;case "touchend":a._touching=!1}if(!d.touches||2!=d.touches.length)return!1;switch(c.type){case "touchstart":b._touches=
[[],[]];break;case "touchmove":var e=a.$offset(b.id),k=b._touches[0],r=b._touches[1];k.push([d.touches[0].pageX-e.left,d.touches[0].pageY-e.top]);r.push([d.touches[1].pageX-e.left,d.touches[1].pageY-e.top]);d=k.length;3<d&&(k.shift(),r.shift());2<=d&&b.applet._processGesture(b._touches)}return!0};a._jsSetMouse=function(b){a.$bind(b,"mousedown touchstart",function(c){a._setMouseOwner(b,!0);c.stopPropagation();c.preventDefault();b.isDragging=!0;if("touchstart"==c.type&&a._gestureUpdate(b,c))return!1;
a._setConsoleDiv(b.applet._console);var d=a._jsGetXY(b,c);if(!d)return!1;2!=c.button&&a.Swing.hideMenus(b.applet);b.applet._processEvent(501,d);return!1});a.$bind(b,"mouseup touchend",function(c){a._setMouseOwner(null);c.stopPropagation();c.preventDefault();b.isDragging=!1;if("touchend"==c.type&&a._gestureUpdate(b,c))return!1;c=a._jsGetXY(b,c);if(!c)return!1;b.applet._processEvent(502,c);return!1});a.$bind(b,"mousemove touchmove",function(c){c.stopPropagation();c.preventDefault();if("touchmove"==
c.type&&a._gestureUpdate(b,c))return!1;c=a._jsGetXY(b,c);if(!c)return!1;b.isDragging||(c[2]=0);b.applet._processEvent(b.isDragging?506:503,c);return!1});a.$bind(b,"DOMMouseScroll mousewheel",function(c){c.stopPropagation();c.preventDefault();b.isDragging=!1;var d=c.originalEvent,d=d.detail?d.detail:("mac"==a.featureDetection.os?1:-1)*d.wheelDelta;c=a._jsGetMouseModifiers(c);b.applet._processEvent(-1,[0>d?-1:1,0,c]);return!1});a.$bind(b,"contextmenu",function(){return!1});a.$bind(b,"mouseout",function(c){b.applet._applet&&
...
!1);"JSV"==c._viewType||k.endsWith(".jdx")?a.Cache.put(k,d):c._applet.viewer.cachePut(k,d);c._applet.viewer.openFileAsyncSpecial(k,1)}};d.readAsArrayBuffer(e)})}})(Jmol,jQuery);Jmol._debugCode=!1;
...
0;c<(arguments.length-1)/2;c++){var b=arguments[c+c+1];a[b]=a.prototype[b]=arguments[c+c+2]}};a.prepareFields=function(d,c){var b=[];if(null!=d.con$truct)for(var f=d.con$truct.stacks,e=0;e<f.length;e++)b[e]=f[e];a.addProto(d.prototype,"con$truct",d.con$truct=function(){var a=arguments.callee.stacks;if(null!=a)for(var c=0;c<a.length;c++)a[c].apply(this,[])});b[b.length]=c;d.con$truct.stacks=b;d.con$truct.index=0};a.registerSerializableFields=function(a){var c=arguments,b=c.length,f=[];if(null!=a.declared$Fields)for(var e=
0;e<a.declared$Fields.length;e++)f[e]=a.declared$Fields[e];a.declared$Fields=f;if(0<b&&1==b%2){f=a.declared$Fields;for(e=1;e<=(b-1)/2;e++){for(var g={name:c[e+e-1],type:c[e+e]},k=!1,r=0;r<f.length;r++)if(f[r].name==g.name){f[r].type=g.type;k=!0;break}k||(f[f.length]=g)}}};a.getMixedCallerMethod=function(d){var c={};d=d.callee.caller;if(null==d||d!==a.tryToSearchAndExecute&&(d=d.arguments.callee.caller,null==d)||d!==a.tryToSearchAndExecute)return null;d=d.arguments.callee.caller;if(null==d||d!==a.searchAndExecuteMethod)return null;
c.claxxRef=d.arguments[1];c.fxName=d.arguments[2];c.paramTypes=a.getParamsType(d.arguments[3]);d=d.arguments.callee.caller;if(null==d)return null;d=d.arguments.callee.caller;if(null==d)return null;c.caller=d;return c};c$=null;a.cStack=[];a.pu$h=function(d){d&&a.cStack.push(d)};a.p0p=function(){return a.cStack.pop()};a.tracingCalling=!1;a._initializingException=!1;a.callingStack=function(a,c){this.caller=a;this.owner=c};a._callingStackTraces=[];a.pu$hCalling=function(d){a._callingStackTraces[a._callingStackTraces.length]=
d};a.p0pCalling=function(){var d=a._callingStackTraces.length;return 0<d?(d=a._callingStackTraces[d-1],a._callingStackTraces.length--,d):null};a.load=function(a,c,b,f){null!=f&&f();delete c$};java.lang.Object=a._O;a._O.getName=a._innerFunctions.getName;System={props:null,$props:{},arraycopy:function(a,c,b,f,e){if(a!==b)for(var g=0;g<e;g++)b[f+g]=a[c+g];else{for(var k=[],g=0;g<e;g++)k[g]=a[c+g];for(g=0;g<e;g++)b[f+g]=k[g]}},currentTimeMillis:function(){return(new Date).getTime()},gc:function(){},getProperties:function(){return System.props},
getProperty:function(a,c){if(System.props)return System.props.getProperty(a,c);var b=System.$props[a];return null!=b?b:1==arguments.length?null:null!=c?c:a},getSecurityManager:function(){return null},setProperties:function(a){System.props=a},setProperty:function(a,c){if(null==System.props)return System.$props[a]=c;System.props.setProperty(a,c)}};System.setProperty("line.separator",0<=navigator.userAgent.indexOf("Windows")?"\r\n":"\n");System.setProperty("os.name",navigator.userAgent);System.out=new a._O;
...
a.intCast=function(a){var c=(a&4278190080)>>24,b=(a&16711680)>>16,f=(a&65280)>>8;a&=255;return 0!=(c&128)?-(((c&127)<<24)+(b<<16)+(f<<8)+a+1):(c<<24)+(b<<16)+(f<<8)+a};a.shortCast=function(){var a=(n&65280)>>8,c=n&255;return 0!=(a&128)?-(((a&127)<<8)+c+1):(a<<8)+b4};a.byteCast=function(a){return 0!=(a&128)?-((a&127)+1):a&255};a.charCast=function(a){return String.fromCharCode(a&255).charAt(0)};a.floatCast=function(a){return a};a.longMasks=[];a.longReverseMasks=[];a.longBits=[];m=[1];for(g=1;53>g;g++)m[g]=
m[g-1]+m[g-1];a.longBits=m;a.longMasks[52]=m[52];for(g=51;0<=g;g--)a.longMasks[g]=a.longMasks[g+1]+m[g];a.longReverseMasks[0]=m[0];for(g=1;52>g;g++)a.longReverseMasks[g]=a.longReverseMasks[g-1]+m[g];a.longLeftShift=function(d,c){if(0==c)return d;if(64<=c)return 0;if(52<c)return error("[Java2Script] Error : JavaScript does not support long shift!"),d;if(0!=(d&a.longMasks[c-1]))return error("[Java2Script] Error : Such shift operator results in wrong calculation!"),d;var b=d&a.longMasks[20+c];return 0!=
...
3;c.MODE_XHR_ASYNC=1;c.unwrapArray=function(a){if(null==a||0==a.length)return a;for(var c=null,b=0;b<a.length;b++)if(null!=a[b]){if("$"==a[b].charAt(0))if("."==a[b].charAt(1)){if(null==c)continue;var d=c.lastIndexOf(".");-1!=d&&(c=c.substring(0,d),a[b]=c+a[b].substring(1))}else a[b]="org.eclipse.s"+a[b].substring(1);c=a[b]}return a};c.classQueue=[];c.classpathMap={};c.packageClasspath=function(a,b,d){var e=c.classpathMap,f=!0==d&&null!=e["@"+a];d&&(null==e["@java"]&&0!=a.indexOf("java"))&&c.assurePackageClasspath("java");
if(a instanceof Array){c.unwrapArray(a);for(e=0;e<a.length;e++)c.packageClasspath(a[e],b,d)}else{if("java"==a||"java.*"==a){var g="@net.sf.j2s.ajax";null==e[g]&&null!=b&&(e[g]=b);g="@net.sf.j2s";null==e[g]&&null!=b&&(e[g]=b)}else"swt"==a?a="org.eclipse.swt":"ajax"==a?a="net.sf.j2s.ajax":"j2s"==a&&(a="net.sf.j2s");a.lastIndexOf(".*")==a.length-2&&(a=a.substring(0,a.length-2));null!=b&&(e["@"+a]=b);!0==d&&(!0!=window[a+".registered"]&&!f)&&(c.pkgRefCount++,"java"==a&&(a="core"),c.loadClass(a+".package",
function(){c.pkgRefCount--;0==c.pkgRefCount&&c.runtimeLoaded()},!0))}};c.pkgRefCount=0;c.jarClasspath=function(a,b){b instanceof Array||(b=[classes]);c.unwrapArray(b);for(var d=0;d<b.length;d++)c.classpathMap["#"+b[d]]=a;c.classpathMap["$"+a]=b};c.registerPackages=function(b,e){c.checkInteractive();for(var f=c.getClasspathFor(b+".*",!0),g=0;g<e.length;g++)null!=window.Clazz&&a.declarePackage(b+"."+e[g]),c.packageClasspath(b+"."+e[g],f)};c.multipleSites=function(a){var b=window["j2s.update.delta"];
if(null!=b&&b instanceof Array&&3<=b.length)for(var d=null,e=null,f=0;f<b.length/3;f++){var g=b[f+f+f];"$"!=g&&(d=g);g=b[f+f+f+1];"$"!=g&&(e=g);var g=b[f+f+f+2],l=d+"/"+g,m=a.indexOf(l);if(-1!=m&&m==a.length-l.length){a=a.substring(0,m)+e+"/"+g;break}}b=a.length;if(1<c.maxLoadingThreads&&(15<b&&"http://archive."==a.substring(0,15)||9<b&&"http://a."==a.substring(0,9)))if(d=a.lastIndexOf("/"),d<b-3)return e=a.charCodeAt(d+1),f=a.charCodeAt(d+2),m=3*(b-d)+5*e+7*f,a.substring(0,7)+"aeiouy".split("")[m%
6]+a.substring(8);return a};c.getClasspathFor=function(a,b,d){var e=c.classpathMap["#"+a],f=null;if(null!=e){if(!b&&null==d)return c.multipleSites(e);var g=e.lastIndexOf(a.replace(/\./g,"/"));-1!=g?f=e.substring(0,g):(g=a.lastIndexOf("."),-1!=g&&(g=e.lastIndexOf(a.substring(0,g).replace(/\./g,"/")),-1!=g&&(f=e.substring(0,g))))}else for(g=a.lastIndexOf(".");-1!=g;){e=a.substring(0,g);f=c.classpathMap["@"+e];if(null!=f)break;g=a.lastIndexOf(".",g-2)}f=c.assureBase(f);if(b)return c.multipleSites(f);
if(a.lastIndexOf(".*")==a.length-2)return a=f+a.substring(0,g+1).replace(/\./g,"/"),c.multipleSites(a);null==d?d=".js":"."!=d.charAt(0)&&(d="."+d);a=f+a.replace(/\./g,"/")+d;return c.multipleSites(a)};c.assureBase=function(b){null==b&&(b=null!=window.Clazz&&null!=a.binaryFolders&&0!=a.binaryFolders.length?a.binaryFolders[0]:null!=c.binaryFolders&&0!=c.binaryFolders.length?c.binaryFolders[0]:"j2s");b.lastIndexOf("/")!=b.length-1&&(b+="/");return b};c.excludeClassMap={};c.ignore=function(){var a=null;
1==arguments.length&&arguments[0]instanceof Array&&(a=arguments[0]);if(null==a)for(var a=[],b=0;b<arguments.length;b++)a[a.length]=arguments[b];c.unwrapArray(a);for(b=0;b<a.length;b++)c.excludeClassMap["@"+a[b]]=!0};c.isClassExcluded=function(a){return!0==c.excludeClassMap["@"+a]};c.scriptLoading=function(){};c.scriptLoaded=function(){};c.scriptInited=function(){};c.scriptCompleted=function(){};c.classUnloaded=function(){};c.classReloaded=function(){};c.globalLoaded=function(){};c.keepOnLoading=!0;
c.mapPath2ClassNode={};c.xhrOnload=function(b,e){if(400<=b.status||null==b.responseText||0==b.responseText.length){a.alert("xhronload error"+b.responseText);var f=c.failedScripts;null==f[e]?(f[e]=1,c.loadedScripts[e]=!1,c.loadScript(e,"xhrOnload 2nd try")):(a.alert("[Java2Script] ClazzLoader.xhrOnload Error in loading "+e+"!"),c.tryToLoadNext(e))}else c.evaluate(e,b.responseText)};c.evaluate=function(b,e){try{eval(e)}catch(f){var g="[Java2Script] Script error: "+f.message+" \n"+b+"\n\n"+e;alert(g);
a.alert(g);throw f;}c.scriptLoaded(b);c.tryToLoadNext(b)};c.emptyOnRSC=function(){};c.failedScripts={};c.failedHandles={};c.takeAnotherTry=!0;c.generateRemovingFunction=function(a){return function(){if("interactive"!=a.readyState){try{null!=a.parentNode&&a.parentNode.removeChild(a)}catch(b){}a=null}}};c.removeScriptNode=function(a){window["j2s.script.debugging"]||window.setTimeout(c.generateRemovingFunction(a),1)};c.generatingXHROnload=function(a,b){return function(){c.xhrOnload(a,b);b=a=null}};c.generatingXHRCallback=
...
function(a,b){return window.setTimeout(function(){c.takeAnotherTry&&(c.failedScripts[a]=0,c.loadedScripts[a]=!1,0<c.inLoadingThreads&&c.inLoadingThreads--,c.loadScript(a,"ietoloadscriptAgain"))},b?500:15E3)};c.w3cFailedLoadingTest=function(a){return window.setTimeout(function(){a.onerror();a=a.timeoutHandle=null},500)};c.generatingW3CScriptOnCallback=function(b,e){return function(){e&&a.__debuggingBH&&a.alert("############ forError="+e+" path="+b+" ####"+(e?"NOT":"")+"LOADED###");c.isGecko&&null!=
this.timeoutHandle&&(window.clearTimeout(this.timeoutHandle),this.timeoutHandle=null);0<c.inLoadingThreads&&c.inLoadingThreads--;this.onerror=this.onload=null;if(e){var f=c.failedScripts;if(null==f[b]&&c.takeAnotherTry){f[b]=1;e||(c.innerLoadedScripts[this.src]=!1);c.loadedScripts[b]=!1;c.loadScript(b,"w3c script failed");c.removeScriptNode(this);return}e&&c.scriptLoaded(b)}else c.scriptLoaded(b);c.loadingNextByPath(b);c.removeScriptNode(this)}};c.generatingIEScriptOnCallback=function(b){return function(){var e=
c.failedHandles,f=c.failedScripts,g=""+this.readyState,l="loading"==g&&(0==this.src.indexOf("file:")||"file:"==window.location.protocol&&0!=this.src.indexOf("http"));if("loaded"!=g&&"complete"!=g){if(null==f[b]){e[b]=c.ieToLoadScriptAgain(b,l);return}if(1==f[b])return}null!=e[b]&&(window.clearTimeout(e[b]),e[b]=null);if((l||"loaded"==g)&&!c.innerLoadedScripts[this.src]){if(!l&&(null==f[b]||0==f[b])&&c.takeAnotherTry){0<c.inLoadingThreads&&c.inLoadingThreads--;f[b]=1;c.loadedScripts[b]=!1;c.loadScript(b,
"local or loaded failed");c.removeScriptNode(this);return}a.alert("[Java2Script] generatingIEScriptOnCallback Error in loading "+b+"!")}0<c.inLoadingThreads&&c.inLoadingThreads--;c.scriptLoaded(b);this.onreadystatechange=null;c.loadingNextByPath(b);c.removeScriptNode(this)}};a.transport=null;c.loadScript=function(b,e,f){a.currentPath=b;f=!0==f;if(c.loadedScripts[b]&&!f)c.tryToLoadNext(b);else{c.loadedScripts[b]=!0;for(var g=c.classQueue,l=0;l<g.length;l++)if(g[l]==b){for(var m=l;m<g.length-1;m++)g[l]=
g[l+1];g.length--;break}System.out.println("loading... "+b+(e?" -- required by "+e:""));if(c.isUsingXMLHttpRequest)if(c.scriptLoading(b),c.isAsynchronousLoading){if(!a.transport){if(window.XMLHttpRequest)a.transport=new XMLHttpRequest;else try{a.transport=new ActiveXObject("Msxml2.XMLHTTP")}catch(p){a.transport=new ActiveXObject("Microsoft.XMLHTTP")}if(null==a.transport){a.alert("[Java2Script] XMLHttpRequest not supported!");return}}f=a.transport;try{f.open("GET",b,c.isAsynchronousLoading)}catch(q){alert(q+
" "+b)}f.onreadystatechange=c.generatingXHRCallback(f,b);c.inLoadingThreads++;try{f.send(null)}catch(s){a.alert("[Java2Script] Loading file error: "+s.message),c.xhrOnload(f,b)}}else self.Jmol?f=Jmol._getFileData(b):(e=jQuery.ajax({type:"GET",dataType:"text",async:!1,url:b,cached:!0}),f=e.responseText,null==f&&e.state&&(f="alert('error loading file "+b+" state="+e.state()+"')")),c.evaluate(b,f);else if(e=document.createElement("SCRIPT"),e.type="text/javascript",e.src=c.isChrome&&c.reloadingClasses[b]?
b+"?"+Math.floor(1E5*Math.random()):b,g=document.getElementsByTagName("HEAD")[0],f)g.appendChild(e);else{e.defer=!0;if("undefined"==typeof e.onreadystatechange||!c.isIE){if(c.isGecko&&(0==b.indexOf("file:")||"file:"==window.location.protocol&&0!=b.indexOf("http")))e.timeoutHandle=c.w3cFailedLoadingTest(e);e.onload=c.generatingW3CScriptOnCallback(b,!1);e.onerror=c.generatingW3CScriptOnCallback(b,!0);c.isOpera&&(c.needOnloadCheck=!0)}else c.needOnloadCheck=!0,e.onreadystatechange=c.generatingIEScriptOnCallback(b);
c.inLoadingThreads++;g.appendChild(e);c.scriptLoading(b)}}};c.isResourceExisted=function(a,b,c){if(null!=a&&null!=document.getElementById(a))return!0;if(null!=b){var d=b;null!=c&&0==b.indexOf(c)&&(d=b.substring(c.length));if(b.lastIndexOf(".css")==b.length-4){var e=document.getElementsByTagName("LINK");for(b=0;b<e.length;b++){var f=e[b].href;c=f.lastIndexOf(d);if(-1!=c&&c==f.length-d.length)return!0}if(!0==window["css."+a])return!0}else if(b.lastIndexOf(".js")==b.length-4){a=document.getElementsByTagName("SCRIPT");
for(b=0;b<a.length;b++)if(e=a[b].src,c=e.lastIndexOf(d),-1!=c&&c==e.length-d.length)return!0}}return!1};c.queueBe4SWT=[];c.lockQueueBe4SWT=!0;c.isLoadingEntryClass=!0;c.besidesJavaPackage=!1;c.tryToLoadNext=function(a){if(c.lockQueueBe4SWT&&0!=c.pkgRefCount&&a.lastIndexOf("package.js")!=a.length-10&&!c.isOpera){var d=c.queueBe4SWT;d[d.length]=a}else{var e=c.mapPath2ClassNode["@"+a];if(null!=e){var f=c.classpathMap["$"+a];if(null!=f)for(a=0;a<f.length;a++){var g=f[a];if(g!=e.name)if(d=c.findClass(g),
null!=d)d.status<b.STATUS_CONTENT_LOADED&&(d.status=b.STATUS_CONTENT_LOADED,c.updateNode(d));else{d=new b;d.name=g;var l=c.classpathMap["#"+g];null==l&&(alert(g),error("Java2Script implementation error! Please report this bug!"));d.path=l;c.mappingPathNameNode(d.path,g,d);d.status=b.STATUS_CONTENT_LOADED;c.addChildClassNode(c.clazzTreeRoot,d,-1);c.updateNode(d)}}if(e instanceof Array)for(a=0;a<e.length;a++)e[a].status<b.STATUS_CONTENT_LOADED&&(e[a].status=b.STATUS_CONTENT_LOADED,c.updateNode(e[a]));
else if(e.status<b.STATUS_CONTENT_LOADED){d=!1;f=document.getElementsByTagName("SCRIPT");for(a=0;a<f.length;a++)if(c.isIE){if(null!=f[a].onreadystatechange&&f[a].onreadystatechange.path==e.path&&"interactive"==f[a].readyState){d=!0;break}}else if(null!=f[a].onload&&f[a].onload.path==e.path){d=!0;break}d||(e.status=b.STATUS_CONTENT_LOADED,c.updateNode(e))}if(c.keepOnLoading){e=!1;d=c.findNextMustClass(c.clazzTreeRoot,b.STATUS_KNOWN);if(null!=d)for(c.loadClassNode(d);c.inLoadingThreads<c.maxLoadingThreads;){a=
c.findNextMustClass(c.clazzTreeRoot,b.STATUS_KNOWN);if(null==a)break;c.loadClassNode(a)}else if(f=c.classQueue,0!=f.length){d=f[0];for(a=0;a<f.length-1;a++)f[a]=f[a+1];f.length--;!c.loadedScripts[d.path]||0!=f.length||!c.isLoadingEntryClass||null!=d.musts&&0!=d.musts.length||null!=d.optionals&&0!=d.optionals.length?(c.addChildClassNode(c.clazzTreeRoot,d,1),c.loadScript(d.path,d.requiredBy)):c.isLoadingEntryClass&&(c.isLoadingEntryClass=!1)}else if(d=c.findNextOptionalClass(b.STATUS_KNOWN),null!=d)for(c.loadClassNode(d);c.inLoadingThreads<
c.maxLoadingThreads;){a=c.findNextOptionalClass(b.STATUS_KNOWN);if(null==a)break;c.loadClassNode(a)}else e=!0;if(e&&0==c.inLoadingThreads){for(;null!=(d=c.findNextMustClass(c.clazzTreeRoot,b.STATUS_CONTENT_LOADED));)c.updateNode(d);for(a=null;null!=(d=c.findNextOptionalClass(b.STATUS_CONTENT_LOADED));)a===d&&(d.status=b.STATUS_OPTIONALS_LOADED),c.updateNode(d),a=d;for(;!(c.tracks=[],!c.checkOptionalCycle(c.clazzTreeRoot)););for(a=null;null!=(d=c.findNextMustClass(c.clazzTreeRoot,b.STATUS_DECLARED))&&
a!==d;)c.updateNode(d),a=d;for(a=null;null!=(d=c.findNextOptionalClass(b.STATUS_DECLARED))&&a!==d;)c.updateNode(d),a=d;for(e=[];null!=(d=c.findNextMustClass(c.clazzTreeRoot,b.STATUS_DECLARED));)e[e.length]=d,d.status=b.STATUS_OPTIONALS_LOADED;for(;null!=(d=c.findNextOptionalClass(b.STATUS_DECLARED));)e[e.length]=d,d.status=b.STATUS_OPTIONALS_LOADED;for(a=0;a<e.length;a++)c.destroyClassNode(e[a]);for(a=0;a<e.length;a++)d=e[a].optionalsLoaded,null!=d&&(e[a].optionalsLoaded=null,d());c.globalLoaded()}}}}};
c.tracks=[];c.checkOptionalCycle=function(a){for(var d=c.tracks,e=d.length,f=-1,g=0;g<d.length;g++)if(d[g]===a&&d[g].status>=b.STATUS_DECLARED){f=g;break}d[d.length]=a;if(-1!=f){for(g=f;g<d.length;g++){d[g].status=b.STATUS_OPTIONALS_LOADED;c.destroyClassNode(d[g]);for(a=0;a<d[g].parents.length;a++)c.updateNode(d[g].parents[a]);d[g].parents=[];a=d[g].optionalsLoaded;null!=a&&(d[g].optionalsLoaded=null,a())}d.length=0;return!0}for(g=0;g<a.musts.length;g++)if(a.musts[g].status==b.STATUS_DECLARED&&c.checkOptionalCycle(a.musts[g]))return!0;
for(g=0;g<a.optionals.length;g++)if(a.optionals[g].status==b.STATUS_DECLARED&&c.checkOptionalCycle(a.optionals[g]))return!0;d.length=e;return!1};c.updateNode=function(a){if(null==a.name||a.status>=b.STATUS_OPTIONALS_LOADED)c.destroyClassNode(a);else{var d=!1;if(null==a.musts||0==a.musts.length||null==a.declaration)d=!0;else for(var d=!0,e=a.musts.length,f=e-1;0<=f;f--){var g=a.musts[f];g.requiredBy=a;if(g.status<b.STATUS_DECLARED){if(c.isClassDefined(g.name)){var l=[];g.status=b.STATUS_OPTIONALS_LOADED;
c.destroyClassNode(g);if(null!=g.declaration&&null!=g.declaration.clazzList){for(var m=g.declaration.clazzList,p=0;p<m.length;p++){var q=c.findClass(m[p]);q.status!=b.STATUS_OPTIONALS_LOADED&&q!==g&&(q.status=g.status,q.declaration=null,c.destroyClassNode(q),null!=q.optionalsLoaded&&(l[l.length]=q))}g.declaration=null}null!=g.optionalsLoaded&&(l[l.length]=g);for(p=0;p<l.length;p++)g=l[p].optionalsLoaded,null!=g&&(l[p].optionalsLoaded=null,g())}else g.status==b.STATUS_CONTENT_LOADED&&c.updateNode(g),
g.status<b.STATUS_DECLARED&&(d=!1);a.musts.length!=e&&(f=e=a.musts.length,d=!0)}}if(d){if(a.status<b.STATUS_DECLARED&&(f=a.declaration,null!=f&&(!1==f.executed?(f(),f.executed=!0):f()),a.status=b.STATUS_DECLARED,null!=c.definedClasses&&(c.definedClasses[a.name]=!0),c.scriptInited(a.path),null!=a.declaration&&null!=a.declaration.clazzList)){m=a.declaration.clazzList;for(p=0;p<m.length;p++)q=c.findClass(m[p]),q.status!=b.STATUS_DECLARED&&q!==a&&(q.status=b.STATUS_DECLARED,null!=c.definedClasses&&(c.definedClasses[q.name]=
!0),c.scriptInited(q.path))}d=b.STATUS_DECLARED;m=!1;if((null==a.optionals||0==a.optionals.length)&&(null==a.musts||0==a.musts.length)||a.status>b.STATUS_KNOWN&&null==a.declaration)m=!0;else{m=!0;for(f=0;f<a.musts.length;f++)if(g=a.musts[f],g.status<b.STATUS_OPTIONALS_LOADED){m=!1;break}if(m)for(f=0;f<a.optionals.length;f++)if(g=a.optionals[f],g.status<b.STATUS_OPTIONALS_LOADED){m=!1;break}}if(m){d=b.STATUS_OPTIONALS_LOADED;a.status=d;c.scriptCompleted(a.path);g=a.optionalsLoaded;if(null!=g&&(a.optionalsLoaded=
null,g(),!c.keepOnLoading))return!1;c.destroyClassNode(a);if(null!=a.declaration&&null!=a.declaration.clazzList){m=a.declaration.clazzList;for(p=0;p<m.length;p++)if(q=c.findClass(m[p]),q.status!=d&&q!==a){q.status=d;q.declaration=null;c.scriptCompleted(q.path);g=q.optionalsLoaded;if(null!=g&&(q.optionalsLoaded=null,g(),!c.keepOnLoading))return!1;c.destroyClassNode(a)}}}c.updateParents(a,d)}}};c.updateParents=function(a,d){if(!(null==a.parents||0==a.parents.length)){for(var e=0;e<a.parents.length;e++){var f=
a.parents[e];f.status>=d||c.updateNode(f)}d==b.STATUS_OPTIONALS_LOADED&&(a.parents=[])}};c.findNextMustClass=function(a,d){if(null!=a){if(null!=a.musts&&0!=a.musts.length)for(var e=0;e<a.musts.length;e++){var f=a.musts[e];if(f.status==d&&(d!=b.STATUS_KNOWN||!0!=c.loadedScripts[f.path])&&(d==b.STATUS_DECLARED||!c.isClassDefined(f.name)))return f;f=c.findNextMustClass(f,d);if(null!=f)return f}if(a.status==d&&(d!=b.STATUS_KNOWN||!0!=c.loadedScripts[a.path])&&(d==b.STATUS_DECLARED||!c.isClassDefined(a.name)))return a}return null};
c.usedRandoms={};c.usedRandoms["r0.13412"]=0.13412;c.findNextOptionalClass=function(a){for(var b=0;;){var b=Math.random(),d="r"+b;if(c.usedRandoms[d]!=b){c.usedRandoms[d]=b;break}}c.clazzTreeRoot.random=b;return c.findNodeNextOptionalClass(c.clazzTreeRoot,a)};c.findNodeNextOptionalClass=function(a,d){var e=c.clazzTreeRoot.random;if(null!=a.musts&&0!=a.musts.length){var f=c.searchClassArray(a.musts,e,d);if(null!=f&&(d!=b.STATUS_KNOWN||!0!=c.loadedScripts[f.path])&&(d==b.STATUS_DECLARED||!c.isClassDefined(f.name)))return f}return null!=
a.optionals&&0!=a.optionals.length&&(f=c.searchClassArray(a.optionals,e,d),null!=f&&(d!=b.STATUS_KNOWN||!0!=c.loadedScripts[f.path])&&(d==b.STATUS_DECLARED||!c.isClassDefined(f.name)))?f:a.status==d&&(d!=b.STATUS_KNOWN||!0!=c.loadedScripts[a.path])&&(d==b.STATUS_DECLARED||!c.isClassDefined(a.name))?a:null};c.searchClassArray=function(a,d,f){for(var e=0;e<a.length;e++){var g=a[e];if(g.status==f&&(f!=b.STATUS_KNOWN||!0!=c.loadedScripts[g.path])&&(f==b.STATUS_DECLARED||!c.isClassDefined(g.name))||g.random!=
d&&(g.random=d,g=c.findNodeNextOptionalClass(g,f),null!=g))return g}return null};c.innerLoadedScripts={};c.interactiveScript=null;c.needOnloadCheck=!1;c.checkInteractive=function(){if(c.needOnloadCheck){var a=c.interactiveScript;if(!(null!=a&&"interactive"==a.readyState)){c.interactiveScript=null;for(var a=document.getElementsByTagName("SCRIPT"),b=0;b<a.length;b++)"interactive"==a[b].readyState&&null!=a[b].onreadystatechange?(c.interactiveScript=a[b],c.innerLoadedScripts[a[b].src]=!0):c.isOpera&&
"loaded"==a[b].readyState&&(null!=a[b].src&&0!=a[b].src.length)&&(c.innerLoadedScripts[a[b].src]=!0)}}};c.load=function(a,d,f,e){c.checkInteractive();if(d instanceof Array){c.unwrapArray(d);for(var g=0;g<d.length;g++)c.load(a,d[g],f,e,d)}else{"$"==d.charAt(0)&&(d="org.eclipse.s"+d.substring(1));var l=c.mapPath2ClassNode["#"+d];if(null==l){var m=c.findClass(d),l=null!=m?m:new b;l.name=d;g=c.classpathMap["#"+d];null==g&&(g="unknown");l.path=g;c.mappingPathNameNode(l.path,d,l);l.status=b.STATUS_KNOWN;
c.addChildClassNode(c.clazzTreeRoot,l,-1)}if(null!=a&&0!=a.length){c.unwrapArray(a);for(g=0;g<a.length;g++)if(m=a[g],!(null==m||0==m.length)&&!c.isClassDefined(m)&&!c.isClassExcluded(m))m=c.findClass(m),null==m&&(m=new b,m.name=a[g],m.status=b.STATUS_KNOWN),m.requiredBy=l,c.addChildClassNode(l,m,1)}5==arguments.length&&null!=e&&(e.status=l.status,e.clazzList=arguments[4]);l.declaration=e;null!=e&&(l.status=b.STATUS_CONTENT_LOADED);if(null!=f&&0!=f.length){c.unwrapArray(f);for(g=0;g<f.length;g++)if(m=
f[g],!(null==m||0==m.length)&&!c.isClassDefined(m)&&!c.isClassExcluded(m))m=c.findClass(m),null==m&&(m=new b,m.name=f[g],m.status=b.STATUS_KNOWN),c.addChildClassNode(l,m,-1)}}};null!=window.Clazz&&(a.load=c.load);c.findClass=function(a){for(var b=0;;){var b=Math.random(),d="r"+b;if(c.usedRandoms[d]!=b){c.usedRandoms[d]=b;break}}c.clazzTreeRoot.random=b;return c.findClassUnderNode(a,c.clazzTreeRoot)};c.findClassUnderNode=function(a,b){var d=c.clazzTreeRoot.random;if(b.name==a)return b;for(var f=0;f<
b.musts.length;f++){var e=b.musts[f];if(e.name==a||e.random!=d&&(e.random=d,e=c.findClassUnderNode(a,e),null!=e))return e}for(f=0;f<b.optionals.length;f++)if(e=b.optionals[f],e.name==a||e.random!=d&&(e.random=d,e=c.findClassUnderNode(a,e),null!=e))return e;return null};c.mappingPathNameNode=function(a,b,d){var e=c.mapPath2ClassNode,f="@"+a;a=e[f];if(null!=a)if(a instanceof Array){for(var f=!1,g=0;g<a.length;g++)if(a[g].name==b){f=!0;break}f||(a[a.length]=d)}else g=[],g[0]=a,g[1]=d,e[f]=g;else e[f]=
d;e["#"+b]=d};c.loadClassNode=function(a){var b=a.name;if(!c.isClassDefined(b)&&!c.isClassExcluded(b)){var d=c.getClasspathFor(b);a.path=d;c.mappingPathNameNode(d,b,a);if(!c.loadedScripts[d])return c.loadScript(d,a.requiredBy),!0}return!1};c.runtimeKeyClass="java.lang.String";c.queueBe4KeyClazz=[];c.getJ2SLibBase=function(){var a=window["j2s.lib"];if(null!=a)return null==a.base&&(a.base="http://archive.java2script.org/"),a.base+("."==a.alias?"":(a.alias?a.alias:a.version?a.version:"1.0.0")+"/");for(var a=
document.getElementsByTagName("SCRIPT"),b=0;b<a.length;b++){var d=a[b].src,e=d.indexOf("j2slib.z.js");if(-1!=e)return d.substring(0,e);e=d.indexOf("j2slibcore.z.js");if(-1!=e)return d.substring(0,e);e=c.classpathMap["@java"];if(null!=e)return e;e=d.indexOf("java/lang/ClassLoader.js");if(-1!=e)return d.substring(0,e)}return null};c.J2SLibBase=null;c.fastGetJ2SLibBase=function(){null==c.J2SLibBase&&(c.J2SLibBase=c.getJ2SLibBase());return c.J2SLibBase};c.assurePackageClasspath=function(a){var b=window[a+
".registered"];!1!=b&&(!0!=b&&null==c.classpathMap["@"+a])&&(window[a+".registered"]=!1,b=c.fastGetJ2SLibBase(),null==b&&(b="j2s"),c.packageClasspath(a,b,!0))};c.loadClass=function(e,f,g,l){if("boolean"==typeof f)return a.evalType(e);c.assurePackageClasspath("java");c.assurePackageClasspath("core");(0==e.indexOf("org.eclipse.swt")||0==e.indexOf("$wt"))&&c.assurePackageClasspath("org.eclipse.swt");0==e.indexOf("junit")&&c.assurePackageClasspath("junit");c.keepOnLoading=!0;if(!g&&(0!=c.pkgRefCount&&
e.lastIndexOf(".package")!=e.length-8||!c.isClassDefined(c.runtimeKeyClass)&&0!=e.indexOf("java.")))l=c.queueBe4KeyClazz,l[l.length]=[e,f];else if(!c.isClassDefined(e)&&!c.isClassExcluded(e)){var m=c.getClasspathFor(e),p=c.loadedScripts[m];l=c.classQueue;if(!p)for(g=l.length-1;0<=g;g--)if(l[g].path==m||l[g].name==e)p=!0;if(p){if(null!=f&&(p=c.findClass(e),null!=p))if(null==p.optionalsLoaded)p.optionalsLoaded=f;else if(f!=p.optionalsLoaded){var q=p.optionalsLoaded;p.optionalsLoaded=function(){q();
f()}}}else{p=null;null!=a.unloadedClasses[e]&&(p=c.findClass(e));null==p&&(p=new b);p.name=e;p.path=m;c.mappingPathNameNode(m,e,p);p.optionalsLoaded=f;p.status=b.STATUS_KNOWN;var s=!1;for(g=l.length-1;0<=g;g--)if(l[g].status!=b.STATUS_OPTIONALS_LOADED){s=!0;break}if(m.lastIndexOf("package.js")==m.length-10){m=!1;for(g=l.length-1;0<=g;g--){e=l[g].name;if(e.lastIndexOf("package.js")==e.length-10){l[g+1]=p;m=!0;break}l[g+1]=l[g]}m||(l[0]=p)}else s&&(l[l.length]=p);s||(e=!1,null!=f&&(e=c.isLoadingEntryClass,
c.isLoadingEntryClass=!0),c.addChildClassNode(c.clazzTreeRoot,p,1),c.loadScript(p.path),null!=f&&(c.isLoadingEntryClass=e))}}else if(null!=f&&c.isClassDefined(e)&&(e=c.findClass(e),null==e||e.status>=b.STATUS_OPTIONALS_LOADED))l?window.setTimeout(f,25):f()};c.loadJ2SApp=function(b,e,f){if(null!=b){var g=b;"$"==b.charAt(0)&&(g="org.eclipse.s"+b.substring(1));var l=-1;if(-1!=(l=g.indexOf("@")))b=g.substring(l+1),c.setPrimaryFolder(b),g=g.substring(0,l),l=g.lastIndexOf("."),-1!=l&&(l=g.substring(0,l),
c.packageClasspath(l,b));if(null==e||!(e instanceof Array))e=[];if(null==f){var m=g,p=e;f=function(){a.evalType(m).main(p)}}else f=f(g,e);c.loadClass(g,f)}};c.loadJUnit=function(b,e){c.loadJ2SApp(b,e,function(b){return function(){c.loadClass("junit.textui.TestRunner",function(){junit.textui.TestRunner.run(a.evalType(b))})}})};c.runtimeLoaded=function(){if(0==c.pkgRefCount&&c.isClassDefined(c.runtimeKeyClass)){for(var a=c.queueBe4KeyClazz,b=0;b<a.length;b++)c.loadClass(a[b][0],a[b][1]);c.queueBe4KeyClazz=
[]}};c.loadZJar=function(a,b){var d=b,e=b instanceof Array;e&&(d=b[b.length-1]);c.jarClasspath(a,e?b:[b]);b==c.runtimeKeyClass?c.loadClass(d,c.runtimeLoaded,!0):c.loadClass(d,null,!0)};c._nodeMap={};c._allNodes=[];c.addChildClassNode=function(a,b,d){var e=!1,f=null;1==d?(f=a.musts,b.requiredBy||(b.requiredBy=a),a.requires||(a.requires=[],a.requiresMap={}),a.requiresMap[b.name]||(a.requiresMap[b.name]=b,a.requires.push[b])):f=a.optionals;c._nodeMap[b.name]||(c._allNodes.push(b),c._nodeMap[b.name]=
b);for(d=0;d<f.length;d++)if(f[d].name==b.name){e=!0;break}if(!e){f[f.length]=b;if(0==b.name.indexOf("org.eclipse.swt")||0==b.name.indexOf("$wt"))window["swt.lazy.loading.callback"]=c.swtLazyLoading,c.assurePackageClasspath("org.eclipse.swt");c.isLoadingEntryClass&&(0!=b.name.indexOf("java")&&0!=b.name.indexOf("net.sf.j2s.ajax"))&&(c.besidesJavaPackage&&(c.isLoadingEntryClass=!1),c.besidesJavaPackage=!0)}e=!1;for(d=0;d<b.parents.length;d++)if(b.parents[d].name==a.name){e=!0;break}!e&&(null!=a.name&&
a!=c.clazzTreeRoot&&a!=b)&&(b.parents[b.parents.length]=a)};c.swtLazyLoading=function(){c.lockQueueBe4SWT=!1;for(var a=c.queueBe4SWT,b=0;b<a.length;b++)c.tryToLoadNext(a[b]);c.queueBe4SWT=[]};c.removeFromArray=function(a,b){if(null==b||null==a)return!1;for(var c=0,d=0;d<b.length;d++)b[d]!==a&&(c<d&&(b[c]=b[d]),c++);b.length=c;return!1};c.destroyClassNode=function(a){var b=a.parents;if(null!=b)for(var d=0;d<b.length;d++)c.removeFromArray(a,b[d].musts)||c.removeFromArray(a,b[d].optionals)};c.unloadClassExt=
function(a){null!=c.definedClasses&&(c.definedClasses[a]=!1);if(null!=c.classpathMap["#"+a]){var d=c.classpathMap["#"+a];c.classpathMap["#"+a]=null;for(var e=c.classpathMap["$"+d],f=!1,g=0;g<e.length;g++)if(e[g]==a){for(f=g;f<e.length-1;f++)e[f]=e[f+1];e.length--;f=!0;break}f&&(c.classpathMap["$"+d]=e)}d=c.findClass(a);null!=d&&(d.status=b.STATUS_KNOWN,c.loadedScripts[d.path]=!1);d=c.getClasspathFor(a);c.loadedScripts[d]=!1;c.innerLoadedScripts[d]&&(c.innerLoadedScripts[d]=!1);c.classUnloaded(a)};
c.assureInnerClass=function(b,c){var e=b.__CLASS_NAME__;if(a.unloadedClasses[e]&&-1==e.indexOf("$")){var f=[],e=e+"$",g;for(g in a.unloadedClasses)null!=a.unloadedClasses[g]&&0==g.indexOf(e)&&(f[f.length]=g);if(0!=f.length&&(f=""+c,g=f.indexOf(e),-1!=g)){var l=f.indexOf('"',g+e.length);-1!=l&&(e=f.substring(g,l),null!=a.unloadedClasses[e]&&(g=f.indexOf("{",l),-1!=g&&(g++,l=f.indexOf("("+e+",",g+3),-1!=l&&(l=f.lastIndexOf("}",l-1),-1!=l&&(f=f.substring(g,l),eval(f),a.unloadedClasses[e]=null)))))}}}})(a,
a._Loader,a._Node);a._LoaderProgressMonitor=function(){};var e=a._LoaderProgressMonitor;e.fadeOutTimer=null;e.fadeAlpha=0;e.monitorEl=null;e.lastScrollTop=0;e.bindingParent=null;e.DEFAULT_OPACITY=self.Jmol&&Jmol._j2sLoadMonitorOpacity?Jmol._j2sLoadMonitorOpacity:55;e.clearChildren=function(a){if(null!=a)for(var c=a.childNodes.length-1;0<=c;c--){var b=a.childNodes[c];if(null!=b){null!=b.childNodes&&0!=b.childNodes.length&&this.clearChildren(b);try{a.removeChild(b)}catch(e){}}}};e.setAlpha=function(a){null!=
this.fadeOutTimer&&a==this.DEFAULT_OPACITY&&(window.clearTimeout(this.fadeOutTimer),this.fadeOutTimer=null);this.fadeAlpha=a;navigator.userAgent.toLowerCase();this.monitorEl.style.filter="Alpha(Opacity="+a+")";this.monitorEl.style.opacity=a/100};e.hiddingOnMouseOver=function(){this.style.display="none"};e.attached=!1;e.cleanup=function(){e.monitorEl=null;e.bindingParent=null;e.attached=!1};e.createHandle=function(){var a=document.createElement("DIV");a.id="clazzloader-status";a.style.cssText="position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:"+
(window["j2s.lib"].monitorZIndex||1E4)+";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";a.onmouseover=this.hiddingOnMouseOver;this.monitorEl=a;null==this.bindingParent?document.body.appendChild(a):this.bindingParent.appendChild(a);return a};e.fadeOut=function(){"none"!=this.monitorEl.style.display&&(this.fadeAlpha==this.DEFAULT_OPACITY?(this.fadeOutTimer=window.setTimeout(function(){e.fadeOut()},750),this.fadeAlpha-=5):0<=this.fadeAlpha-10?
(this.setAlpha(this.fadeAlpha-10),this.fadeOutTimer=window.setTimeout(function(){e.fadeOut()},40)):this.monitorEl.style.display="none")};e.getFixedOffsetTop=function(){if(null!=this.bindingParent){var a=this.bindingParent;return a.scrollTop}var c=navigator.userAgent,a=document.body,b=a.parentNode,e=b.clientHeight,a=a.scrollTop+a.offsetTop,g=b.scrollTop+b.offsetTop;return-1==c.indexOf("Opera")&&document.all?0==e?a:g:-1!=c.indexOf("Gecko")?e==b.offsetHeight&&e==b.scrollHeight?a:g:a};e.showStatus=function(a,
c){null==this.monitorEl&&(this.createHandle(),this.attached||(this.attached=!0));this.clearChildren(this.monitorEl);this.monitorEl.appendChild(document.createTextNode(""+a));"none"==this.monitorEl.style.display&&(this.monitorEl.style.display="");this.setAlpha(this.DEFAULT_OPACITY);var b=this.getFixedOffsetTop();this.lastScrollTop!=b&&(this.lastScrollTop=b,this.monitorEl.style.bottom=this.lastScrollTop+4+"px");c&&this.fadeOut()};null!=window.ClazzLoader&&(ClazzLoader.scriptLoading=function(a){e.showStatus("Loading "+
...
0>=a?999999:a};q.maxLatency=40;q.setMaxLatency=function(a){q.maxLatency=0>=a?40:a};q.pinning=!1;q.enablePinning=function(a){q.pinning=a};q.linesCount=0;q.metLineBreak=!1;q.splitNeedFixed=2!="\n".split(/\n/).length;q.splitIntoLineByR=function(a){for(var c=[],b=0,e=-1;;)if(b=a.indexOf("\r",e+1),-1!=b){if(c[c.length]=a.substring(e+1,b),e=b,e+1==a.length){c[c.length]="";break}}else{c[c.length]=a.substring(e+1);break}return c};q.splitIntoLines=function(a){var c=[];if(null==a)return c;for(var b=0,e=-1;;){var b=
a.indexOf("\n",e+1),g=null;-1!=b?(g=0<b&&"\r"==a.charAt(b-1)?a.substring(e+1,b-1):a.substring(e+1,b),e=b):g=a.substring(e+1);for(var g=q.splitIntoLineByR(g),l=0;l<g.length;l++)c[c.length]=g[l];if(-1==b)break;else if(e+1==a.length){c[c.length]="";break}}return c};q.createConsoleWindow=function(){var a=document.createElement("DIV");a.style.cssText="font-family:monospace, Arial, sans-serif;";document.body.appendChild(a);return a};q.consoleOutput=function(a,c){var b=window["j2s.lib"];(b=b&&b.console)&&
"string"==typeof b&&(b=document.getElementById(b));if(!b)return!1;if(q.linesCount>q.maxTotalLines){for(var e=0;e<q.linesCount-q.maxTotalLines;e++)null!=b&&0<b.childNodes.length&&b.removeChild(b.childNodes[0]);q.linesCount=q.maxTotalLines}var g=!1;a="undefined"==typeof a?"":null==a?"null":""+a;0<a.length&&(e=a.charAt(a.length-1),"\n"==e?(a=1<a.length?"\r"==a.charAt(a.length-2)?a.substring(0,a.length-2):a.substring(0,a.length-1):"",g=!0):"\r"==e&&(a=a.substring(0,a.length-1),g=!0));var l=null;a=a.replace(/\t/g,
q.c160);if(q.splitNeedFixed)try{l=q.splitIntoLines(a)}catch(k){window.popup(k.message)}else l=a.split(/\r\n|\r|\n/g);for(e=0;e<l.length;e++){var m=null;if(q.metLineBreak||0==q.linesCount||1>b.childNodes.length)m=document.createElement("DIV"),b.appendChild(m),m.style.whiteSpace="nowrap",q.linesCount++;else try{m=b.childNodes[b.childNodes.length-1]}catch(G){m=document.createElement("DIV"),b.appendChild(m),m.style.whiteSpace="nowrap",q.linesCount++}var A=document.createElement("SPAN");m.appendChild(A);
A.style.whiteSpace="nowrap";null!=c&&(A.style.color=c);0==l[e].length&&(l[e]=String.fromCharCode(160));A.appendChild(document.createTextNode(l[e]));q.pinning||(b.scrollTop+=100);q.metLineBreak=e!=l.length-1?!0:g}g=b.parentNode.className;!q.pinning&&(null!=g&&-1!=g.indexOf("composite"))&&(b.parentNode.scrollTop=b.parentNode.scrollHeight);q.lastOutputTime=(new Date).getTime()};q.clear=function(){try{q.metLineBreak=!0;var a=window["j2s.lib"],c=a&&a.console;if(c&&(c=document.getElementById(c))){for(var b=
c.childNodes,e=b.length-1;0<=e;e--)c.removeChild(b[e]);q.linesCount=0}}catch(g){}};a.alert=function(a){q.consoleOutput(a+"\r\n")};q.c160=String.fromCharCode(160);q.c160+=q.c160+q.c160+q.c160;System.out.print=function(a){q.consoleOutput(a)};System.out.println=function(a){q.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n")};System.err.__CLASS_NAME__="java.io.PrintStream";System.err.print=function(a){q.consoleOutput(a,"red")};System.err.println=function(a){q.consoleOutput("undefined"==
typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};a.setConsoleDiv=function(a){window["j2s.lib"]&&(window["j2s.lib"].console=a)}}(Clazz),Clazz.binaryFolders=Clazz._Loader.binaryFolders=[Clazz._Loader.getJ2SLibBase()],Clazz._Loader.registerPackages("java","io lang lang.reflect util util.regex util.zip net text".split(" ")),Clazz._Loader.ignore("net.sf.j2s.ajax.HttpRequest java.util.MapEntry.Type java.net.UnknownServiceException java.lang.Runtime java.security.AccessController java.security.PrivilegedExceptionAction java.io.File java.io.FileInputStream java.io.FileWriter java.io.OutputStreamWriter java.util.Calendar java.text.SimpleDateFormat java.text.DateFormat java.util.concurrent.Executors".split(" ")))};
___JmolDate="$Date: 2014-04-01 23:19:32 -0500 (Tue, 01 Apr 2014) $";___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";___JmolVersion="14.0.13";

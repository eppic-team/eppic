   ...
   /*  
     if (fill) {//RIBBONS
       ...
       for (;top < numTopStrandPoints && (top + numTopStrandPoints) < size; top++) {
         t1 = (Point3i) points.get(top - 1);
         b1 = (Point3i) points.get(numTopStrandPoints + (top - 1));
         t2 = (Point3i) points.get(top);
         b2 = (Point3i) points.get(numTopStrandPoints + top);
     ...
     */
       for (int top = 0;
         ...
         g3d.drawLine((Point3i) points.get(top),
             (Point3i) points.get(top + numTopStrandPoints));
     //}

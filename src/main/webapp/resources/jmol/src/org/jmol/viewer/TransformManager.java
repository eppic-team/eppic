...
*/    
  ...
  private void setSpinOn(boolean spinOn, float endDegrees, List endPositions, BitSet bsAtoms, boolean isGesture) {
    if (navOn && spinOn)
      setNavOn(false);
    this.spinOn = spinOn;
  ...
  private class SpinThread extends Thread implements Runnable {
    ...
    SpinThread(float endDegrees, List endPositions, BitSet bsAtoms, boolean isNav, boolean isGesture) {

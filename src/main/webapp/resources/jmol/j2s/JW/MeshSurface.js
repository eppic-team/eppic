...
this.vs[this.vc] = JU.P3.newP (vertex);
return this.vc++;
}, "JU.P3");
...
this.vcs[this.iA] = JW.C.getColixTranslucent3 (this.vcs[this.iA], isTranslucent, translucentLevel);
this.vcs[this.iB] = JW.C.getColixTranslucent3 (this.vcs[this.iB], isTranslucent, translucentLevel);
this.vcs[this.iC] = JW.C.getColixTranslucent3 (this.vcs[this.iC], isTranslucent, translucentLevel);
}
this.bsTransPolygons = null;
this.polygonTranslucencies = null;
});
...
this.bsSlabDisplay = JW.BSUtil.setAll (this.pc == 0 ? this.vc : this.pc);
this.bsSlabGhost = null;
...
if (Float.isNaN (fData[i]) || JW.MeshSurface.checkSlab (tokType, this.vs[i], fData[i], distance, plane, ptCenters, bsSource) > 0) this.bsSlabDisplay.clear (i);
}
return;
}var iLast = this.pc;

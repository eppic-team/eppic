...
Clazz.load (["java.util.Hashtable", "JU.P3", "J.c.AXES", "$.CBK"], "JV.GlobalSettings", ["java.lang.Boolean", "$.Float", "JU.BS", "$.DF", "$.List", "$.PT", "$.SB", "J.c.STR", "J.script.SV", "JW.BSUtil", "$.Escape", "$.Logger", "$.Txt", "JV.JC", "$.StateManager", "$.Viewer"], function () {
...
this.vwr.saveScene ("DELETE", null);
});
...
this.app (str, "set defaultLattice " + JW.Escape.eP (this.ptDefaultLattice));

...
Clazz.load (null, "JU.Rdr", ["java.io.BufferedInputStream", "$.BufferedReader", "$.ByteArrayInputStream", "$.InputStreamReader", "$.StringReader", "javajs.api.Interface", "JU.AU", "$.Base64", "$.Encoding", "$.SB"], function () {
c$ = Clazz.declareType (JU, "Rdr");

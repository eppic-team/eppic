...
Clazz.load (["J.script.ScriptParam"], "J.script.ScriptExpr", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "$.Map", "JU.BArray", "$.BS", "$.CU", "$.List", "$.M34", "$.M4", "$.P3", "$.P4", "$.PT", "$.SB", "J.api.Interface", "JM.Atom", "$.BondSet", "$.Group", "$.ModelCollection", "J.script.SV", "$.ScriptContext", "$.ScriptMathProcessor", "$.T", "JW.BSUtil", "$.Elements", "$.Escape", "$.Logger", "$.Measure", "$.Txt"], function () {
...
if (Clazz.instanceOf (v, String) && key != null) v = this.vwr.setUserVariable (key, J.script.SV.newS (v));
return v;
}, "~S,~S");

...
Clazz.load (["J.minimize.forcefield.Calculation"], "J.minimize.forcefield.UFFOOPCalc", null, function () {
c$ = Clazz.declareType (J.minimize.forcefield, "UFFOOPCalc", J.minimize.forcefield.Calculation);

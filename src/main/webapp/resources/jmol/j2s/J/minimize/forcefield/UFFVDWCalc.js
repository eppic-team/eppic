...
Clazz.load (["J.minimize.forcefield.Calculation"], "J.minimize.forcefield.UFFVDWCalc", null, function () {
c$ = Clazz.declareType (J.minimize.forcefield, "UFFVDWCalc", J.minimize.forcefield.Calculation);

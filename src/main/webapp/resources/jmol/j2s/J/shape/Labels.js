...
Clazz.load (["J.shape.AtomShape", "java.util.Hashtable"], "J.shape.Labels", ["javajs.awt.Font", "JU.AU", "$.BS", "$.List", "J.c.PAL", "JM.LabelToken", "$.Text", "J.script.SV", "JW.BSUtil", "$.C", "JV.JC"], function () {

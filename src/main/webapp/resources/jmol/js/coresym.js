...
Clazz_load (["JU.P3"], "J.adapter.smarter.XtalSymmetry", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.BS", "$.M3", "$.M4", "$.P3i", "$.PT", "$.SB", "$.V3", "J.adapter.smarter.Atom", "J.api.Interface", "JW.BSUtil", "$.Escape", "$.Logger"], function () {
...
this.asc.setAtomSetCollectionAuxiliaryInfo ("symmetryRange", Float.$valueOf (factor));
}, "~N");
...
Clazz_defineMethod (c$, "setSuperCell", 
 function (supercell) {
...
this.asc.setAtomSetSpaceGroupName (acr.spaceGroup);
...
if (readerSymmetry != null) this.asc.setAtomSetSpaceGroupName (readerSymmetry.getSpaceGroupName ());
...
if (nOperations == 1) this.asc.checkSpecial = false;
var checkSpecial = this.asc.checkSpecial;
...
if (this.doCentroidUnitCell) this.asc.setAtomSetCollectionAuxiliaryInfo ("centroidMinMax", [this.minXYZ.x, this.minXYZ.y, this.minXYZ.z, this.maxXYZ.x, this.maxXYZ.y, this.maxXYZ.z, (this.centroidPacked ? 1 : 0)]);
...
symmetry.setFinalOperations (name, this.asc.atoms, this.firstSymmetryAtom, this.noSymmetryCount, this.doNormalize);
if (name == null || name.equals ("unspecified!")) this.asc.setAtomSetSpaceGroupName (symmetry.getSpaceGroupName ());
}, "J.api.SymmetryInterface");
...
Clazz_load (["J.api.SymmetryInterface"], "J.symmetry.Symmetry", ["java.lang.Float", "java.util.Hashtable", "JU.BS", "$.P3", "$.SB", "JM.Atom", "J.symmetry.PointGroup", "$.SpaceGroup", "$.SymmetryInfo", "$.SymmetryOperation", "$.UnitCell", "JW.Escape", "$.Logger", "$.SimpleUnitCell"], function () {
c$ = Clazz_decorateAsClass (function () {
...
Clazz_defineMethod (c$, "getSymmetryOperationDescription", 
...
Clazz_defineMethod (c$, "getSymmetryInfoString", 
function () {
...
Clazz_overrideMethod (c$, "setUnitCellOrientation", 
...
Clazz_overrideMethod (c$, "setCartesianOffset", 
function (origin) {
...
Clazz_overrideMethod (c$, "setUnitCellAllFractionalRelative", 
function (TF) {
...
var infolist = null;
if (spaceGroup == null) {
if (modelIndex <= 0) modelIndex = (Clazz_instanceOf (pt1, JM.Atom) ? (pt1).mi : modelSet.vwr.getCurrentModelIndex ());
var isBio = false;
...
Clazz_declarePackage ("J.symmetry");
Clazz_load (["JU.P3", "$.V3"], "J.symmetry.PointGroup", ["java.lang.Float", "java.util.Hashtable", "JU.List", "$.Quat", "$.SB", "JW.BSUtil", "$.Escape", "$.Logger", "$.Txt"], function () {
c$ = Clazz_decorateAsClass (function () {
this.drawInfo = null;
this.info = null;
this.textInfo = null;
...
var ac = JW.BSUtil.cardinalityOf (bsAtoms);
...
Clazz_defineMethod (c$, "getPlane", 
 function (v3) {
if (!this.haveAxis (0, v3) && this.checkOperation (JU.Quat.newVA (v3, 180), this.center, -1)) this.axes[0][this.nAxes[0]++] = Clazz_innerTypeInstance (J.symmetry.PointGroup.Operation, this, null, v3);
return this.nAxes[0];
}, "JU.V3");
...
Clazz_declarePackage ("J.symmetry");
Clazz_load (["java.util.Hashtable"], "J.symmetry.SpaceGroup", ["java.lang.Character", "java.util.Arrays", "JU.AU", "$.List", "$.M4", "$.P3", "$.PT", "$.SB", "J.symmetry.HallInfo", "$.HallTranslation", "$.SymmetryOperation", "JW.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
this.index = 0;
this.isSSG = false;
this.name = "unknown!";
...
Clazz_defineMethod (c$, "getOperationList", 
function () {
...
Clazz_declarePackage ("J.symmetry");
Clazz_load (null, "J.symmetry.HallInfo", ["JU.P3i", "$.SB", "J.symmetry.HallRotationTerm", "$.HallTranslation", "JW.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
this.hallSymbol = null;
...
Clazz_declarePackage ("J.symmetry");
Clazz_load (["JU.M4"], "J.symmetry.HallRotationTerm", ["JU.SB", "J.symmetry.HallRotation", "$.HallTranslation", "$.SymmetryOperation", "JW.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
this.inputCode = null;
...
Clazz_declarePackage ("J.symmetry");
Clazz_load (["JU.M4"], "J.symmetry.SymmetryOperation", ["java.lang.Float", "JU.List", "$.Matrix", "$.P3", "$.P4", "$.PT", "$.Quat", "$.SB", "$.V3", "JW.Escape", "$.Logger", "$.Measure", "$.Parser"], function () {
c$ = Clazz_decorateAsClass (function () {
...
Clazz_declarePackage ("J.symmetry");
Clazz_load (null, "J.symmetry.SymmetryInfo", ["JW.SimpleUnitCell"], function () {
c$ = Clazz_decorateAsClass (function () {
...
Clazz_declarePackage ("J.symmetry");
Clazz_load (["JW.SimpleUnitCell", "JU.P3", "JV.JC"], "J.symmetry.UnitCell", ["java.lang.Float", "JU.M4", "$.V3", "J.api.Interface", "JW.BoxInfo", "$.Escape"], function () {
c$ = Clazz_decorateAsClass (function () {
this.vertices = null;
...
c$.newA = Clazz_overrideMethod (c$, "newA", 
function (notionalUnitcell) {
var c =  new J.symmetry.UnitCell ();
...
Clazz_defineMethod (c$, "setAllFractionalRelative", 
function (TF) {
...
cell0 =  new JU.P3 ();
cell1 =  new JU.P3 ();
JW.SimpleUnitCell.ijkToPoint3f (Clazz_floatToInt (this.unitCellMultiplier.x), cell0, 0);
JW.SimpleUnitCell.ijkToPoint3f (Clazz_floatToInt (this.unitCellMultiplier.y), cell1, 0);
cell1.sub (cell0);
}for (var i = 0; i < 8; i++) {
...
Clazz_defineMethod (c$, "calcUnitcellVertices", 
 function () {

...
Clazz_declarePackage ("J.popup");
Clazz_load (["J.popup.GenericSwingPopup", "java.util.Properties", "JU.List"], "J.popup.JmolGenericPopup", ["java.lang.Boolean", "java.util.Hashtable", "JU.PT", "J.i18n.GT", "J.popup.MainPopupResourceBundle", "JW.Elements", "JV.JC"], function () {
...
this.modelIndex = this.vwr.getCurrentModelIndex ();
...
var info = null;
if (name.indexOf ("captureLooping") >= 0) info = (this.vwr.getAnimationReplayMode ().name ().equals ("ONCE") ? "ONCE" : "LOOP");

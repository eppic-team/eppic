...
Clazz_declarePackage ("J.smiles");
Clazz_load (["J.api.SmilesMatcherInterface"], "J.smiles.SmilesMatcher", ["JU.AU", "$.BS", "$.PT", "J.smiles.InvalidSmilesException", "$.SmilesGenerator", "$.SmilesParser", "JW.BSUtil"], function () {
...
J.smiles.InvalidSmilesException.clear ();
if (asBioSmiles) return ( new J.smiles.SmilesGenerator ()).getBioSmiles (atoms, ac, bsSelected, bioAllowUnmatchedRings, bioAddCrossLinks, bioComment);
return ( new J.smiles.SmilesGenerator ()).getSmiles (atoms, ac, bsSelected, explicitH);
}, "~A,~N,JU.BS,~B,~B,~B,~S,~B");
...
Clazz_declarePackage ("J.smiles");
Clazz_load (["JW.JmolMolecule", "JU.BS", "$.List", "J.smiles.VTemp"], "J.smiles.SmilesSearch", ["java.util.Arrays", "$.Hashtable", "JU.AU", "$.SB", "$.V3", "J.smiles.SmilesAromatic", "$.SmilesAtom", "$.SmilesBond", "$.SmilesMeasure", "$.SmilesParser", "JW.BSUtil", "$.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
...
var sAtom =  new J.smiles.SmilesAtom ().setIndex (this.ac);
...
return true;
}, "J.smiles.SmilesAtom,J.smiles.SmilesAtom,J.smiles.SmilesBond,~N,~N,JW.Edge");
...
}, "J.smiles.SmilesBond,~N,~N,JW.Edge");
...
return true;
}, "JW.Node,J.smiles.SmilesAtom,J.smiles.SmilesAtom,~A");
...
}, "JW.Node,JW.Node,JW.Node,JW.Node,J.smiles.VTemp");
...
Clazz_declarePackage ("J.smiles");
Clazz_load (["java.util.Hashtable", "JU.BS", "J.smiles.VTemp"], "J.smiles.SmilesGenerator", ["JU.List", "$.SB", "J.smiles.InvalidSmilesException", "$.SmilesAromatic", "$.SmilesAtom", "$.SmilesBond", "$.SmilesParser", "$.SmilesSearch", "JW.BNode", "$.BSUtil", "$.Elements", "$.JmolMolecule", "$.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
this.atoms = null;
this.ac = 0;
this.bsSelected = null;
...
sb.append ("[");
if (atomName != null && Clazz_instanceOf (atom, JW.BNode)) {
var a = atom;
...
var groupType = (Clazz_instanceOf (atom, JW.BNode) ? (atom).getBioStructureTypeName () : "");
...
Clazz_declarePackage ("J.smiles");
Clazz_load (["JU.P3", "JW.BNode"], "J.smiles.SmilesAtom", ["JU.AU", "JW.Elements", "$.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
this.atomsOr = null;
this.nAtomsOr = 0;
...
Clazz_declarePackage ("J.smiles");
Clazz_load (["JW.Edge"], "J.smiles.SmilesBond", ["J.smiles.InvalidSmilesException"], function () {
c$ = Clazz_decorateAsClass (function () {
this.atom1 = null;
this.atom2 = null;
this.isNot = false;
...
Clazz_declarePackage ("J.smiles");
Clazz_load (["java.util.Hashtable"], "J.smiles.SmilesParser", ["java.lang.Character", "JU.List", "$.PT", "$.SB", "J.smiles.InvalidSmilesException", "$.SmilesAtom", "$.SmilesBond", "$.SmilesMeasure", "$.SmilesSearch", "JW.Elements", "$.Logger", "$.Txt"], function () {
c$ = Clazz_decorateAsClass (function () {
this.isSmarts = false;
...
Clazz_load (["J.script.JmolSmilesExtension"], "J.scriptext.SmilesExt", ["java.lang.Float", "JU.AU", "$.BS", "$.List", "$.M4", "$.P3", "JW.Escape", "$.Logger", "$.Measure"], function () {
c$ = Clazz_decorateAsClass (function () {
this.e = null;
this.sm = null;
Clazz_instantialize (this, arguments);

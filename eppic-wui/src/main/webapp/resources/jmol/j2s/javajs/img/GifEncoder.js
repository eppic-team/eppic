...
Clazz.load (["javajs.img.ImageEncoder", "JU.List"], "javajs.img.GifEncoder", ["java.lang.Boolean", "java.util.Collections", "$.Hashtable"], function () {
...
Clazz.instantialize (this, arguments);
}, javajs.img.GifEncoder, "ColorVector", JU.List);

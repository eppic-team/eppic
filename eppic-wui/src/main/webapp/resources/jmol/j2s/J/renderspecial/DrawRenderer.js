...
Clazz.load (["J.render.MeshRenderer", "JU.BS", "$.P3", "$.P3i", "$.V3"], "J.renderspecial.DrawRenderer", ["JU.A4", "$.M3", "J.shapespecial.Draw", "JW.C", "$.GData", "$.Measure"], function () {
...
}JW.GData.getHermiteList (tension, this.vertices[this.vertexCount - 3], this.vertices[this.vertexCount - 2], this.vertices[this.vertexCount - 1], this.vertices[this.vertexCount - 1], this.vertices[this.vertexCount - 1], this.controlHermites, 0, nHermites, true);
...
for (var i = 0; i < 4; i++) this.vwr.transformPtScr (this.vertices[i], this.screens[i]);
...
this.vwr.transformPtScr (pts[0], this.pt1i);
this.vwr.transformPtScr (pts[1], this.pt2i);
...
this.vwr.rotatePoint (this.vertices[ptXYZ], this.pt1);
this.pt1.z *= -1;
...
Clazz.defineMethod (c$, "renderInfo", 
 function () {
if (this.mesh.title == null || this.vwr.getDrawHover () || !this.g3d.setColix (this.vwr.getColixBackgroundContrast ())) return;

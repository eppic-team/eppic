...
this.vwr.unTransformPoint (pt, ptCamera);
...
this.vwr.unTransformPoint (this.tempP3, this.tempP3);
...
this.vwr.unTransformPoint (ptA, this.tempP1);
this.vwr.unTransformPoint (ptB, this.tempP2);
}}, "JU.P3,JU.P3,~B");
...
var radius = this.vwr.unscaleToScreen (z, diameter) / 2;
...
this.vwr.unTransformPoint (screenBase, this.tempP1);
this.vwr.unTransformPoint (screenTip, this.tempP2);
var radius = this.vwr.unscaleToScreen (screenBase.z, screenDiameter) / 2;
...
return;
}var mad = Math.round (this.vwr.unscaleToScreen ((screenA.z + screenB.z) / 2, screenDiameter) * 1000);
...
this.vwr.unTransformPoint (pt, this.tempP1);
this.outputSphere (this.tempP1, this.vwr.unscaleToScreen (pt.z, diameter) / 2, colix, true);
}, "~N,~N,JU.P3");
...
this.vwr.unTransformPoint (ptA, this.tempP1);
this.vwr.unTransformPoint (ptB, this.tempP2);
this.vwr.unTransformPoint (ptC, this.tempP3);

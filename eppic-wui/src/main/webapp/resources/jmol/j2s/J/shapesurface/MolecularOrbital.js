...
Clazz.load (["J.shapesurface.Isosurface"], "J.shapesurface.MolecularOrbital", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.AU", "$.List", "$.PT", "$.SB", "J.c.QS", "J.jvxl.data.JvxlCoder", "JW.Escape"], function () {

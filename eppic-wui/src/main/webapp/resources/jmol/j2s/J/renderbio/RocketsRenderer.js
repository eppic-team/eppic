...
Clazz.load (["J.renderbio.StrandsRenderer", "JU.P3", "$.V3"], "J.renderbio.RocketsRenderer", ["J.c.STR", "JMB.AlphaPolymer", "$.Helix", "$.Sheet"], function () {
...
var diameter = Clazz.floatToInt (this.vwr.scaleToScreen (zMid, this.mad));
...
coneDiameter = Clazz.floatToInt (this.vwr.scaleToScreen (Clazz.doubleToInt (Math.floor (screenPtBegin.z)), coneDiameter));

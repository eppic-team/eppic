...
Clazz.load (["J.adapter.readers.quantum.MOReader"], "J.adapter.readers.quantum.GenNBOReader", ["java.lang.Boolean", "$.Character", "$.Exception", "$.Float", "java.util.Hashtable", "JU.AU", "$.List", "$.Rdr", "$.SB", "J.api.JmolAdapter", "JW.Logger"], function () {

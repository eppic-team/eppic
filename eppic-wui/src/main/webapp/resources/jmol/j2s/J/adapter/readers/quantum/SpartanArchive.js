...
Clazz.load (null, "J.adapter.readers.quantum.SpartanArchive", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.AU", "$.List", "$.V3", "J.adapter.readers.quantum.SpartanSmolReader", "J.adapter.smarter.AtomSetCollectionReader", "$.Bond", "J.api.JmolAdapter", "J.c.QS", "JW.Logger"], function () {
...
JW.Logger.debug (this.ac + " atoms read");
}}, "~N,~B");
...
}}if (value != null) this.r.asc.setAtomSetCollectionAuxiliaryInfo (keyName, value);
if (vector.size () != 0) this.r.asc.setAtomSetCollectionAuxiliaryInfo (keyName, vector);
});
...
this.r.asc.setAtomSetCollectionAuxiliaryInfo ("VibFreqs", freqs);
...
this.r.asc.setAtomSetCollectionAuxiliaryInfo ("vibration", vibrations);
});

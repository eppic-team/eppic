...
Clazz.load (["JM.Model"], "JMB.BioModel", ["java.lang.Float", "java.util.Hashtable", "JU.AU", "$.BS", "$.List", "$.SB", "J.api.Interface", "J.c.STR", "JM.AtomCollection", "JMB.AlphaPolymer", "$.Monomer", "$.Resolver", "JW.BSUtil", "$.Escape", "$.Txt", "JV.Viewer"], function () {

...
Clazz.load (null, "JW.ColorEncoder", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.AU", "$.CU", "$.List", "$.PT", "J.c.PAL", "JW.C", "$.Escape", "$.Logger", "JV.JC"], function () {
...
case 0:
return this.ce.argbsRoygb[JW.ColorEncoder.quantize (val, lo, hi, n)];
case 1:
return this.ce.argbsRoygb[JW.ColorEncoder.quantize (-val, -hi, -lo, n)];
case 8:
return this.ce.argbsRoygb[JW.ColorEncoder.quantize (val, lo, hi, n)];
case 9:
return this.ce.argbsRoygb[this.ce.ihalf + JW.ColorEncoder.quantize (val, lo, hi, n) * 2];
case 6:
return this.ce.argbsRwb[JW.ColorEncoder.quantize (val, lo, hi, n)];
case 7:
return this.ce.argbsRwb[JW.ColorEncoder.quantize (-val, -hi, -lo, n)];
case -13:
return (this.ce.userScale.length == 0 ? -8355712 : this.ce.userScale[JW.ColorEncoder.quantize (val, lo, hi, n)]);
case -14:
return (this.ce.userScale.length == 0 ? -8355712 : this.ce.userScale[JW.ColorEncoder.quantize (-val, -hi, -lo, n)]);
case 2:
return this.ce.argbsCpk[JW.ColorEncoder.colorIndex (val, n)];
case 3:
return JW.ColorEncoder.getRasmolScale ()[JW.ColorEncoder.colorIndex (val, n)];
case 4:
return this.ce.argbsShapely[JW.ColorEncoder.colorIndex (val, n)];
case 5:
return this.ce.argbsAmino[JW.ColorEncoder.colorIndex (val, n)];
case 12:
...
JW.ColorEncoder.rasmolScale =  Clazz.newIntArray (J.c.PAL.argbsCpk.length, 0);

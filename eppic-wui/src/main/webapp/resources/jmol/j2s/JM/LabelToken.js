...
function (vwr, atom, strFormat) {
if (strFormat == null || strFormat.length == 0) return null;
var tokens = JM.LabelToken.compile (vwr, strFormat, '\0', null);
return JM.LabelToken.formatLabelAtomArray (vwr, atom, tokens, '\0', null);
}, "JV.Viewer,JM.Atom,~S");
c$.formatLabelAtomArray = Clazz.defineMethod (c$, "formatLabelAtomArray", 
function (vwr, atom, tokens, chAtom, indices) {
...
JM.LabelToken.appendAtomTokenValue (vwr, atom, t, strLabel, indices);
}}
...
function (vwr, bond, tokens, values, indices) {
...
JM.LabelToken.formatLabelAtomArray (vwr, bond.atom1, tokens, '1', indices);
JM.LabelToken.formatLabelAtomArray (vwr, bond.atom2, tokens, '2', indices);
...
for (var i = indices[0]; i >= 1; --i) if (indices[i] >= 0) JM.LabelToken.formatLabelAtomArray (vwr, atoms[indices[i]], tokens, String.fromCharCode (48 + i), null);
...
c$.appendAtomTokenValue = Clazz.defineMethod (c$, "appendAtomTokenValue", 
 function (vwr, atom, t, strLabel, indices) {
var strT = null;
var floatT = NaN;
var ptT = null;
try {
...
break;
case 1666189314:
floatT = JM.Atom.atomPropertyFloat (vwr, atom, t.tok);
break;
case 'r':
...
break;
case 4:
strT = vwr.getModelAtomProperty (atom, t.text.substring (2, t.text.length - 1));
break;
case 1641025539:
case 1238369286:
...
}, "JV.Viewer,JM.Atom,JM.LabelToken,JU.SB,~A");

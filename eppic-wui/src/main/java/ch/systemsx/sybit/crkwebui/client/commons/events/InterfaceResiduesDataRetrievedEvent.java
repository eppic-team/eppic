...
public class InterfaceResiduesDataRetrievedEvent extends GwtEvent<InterfaceResiduesDataRetrievedHandler> 
{
	 ...
	 */
	private final HashMap<Integer, List<ResidueBurial>> interfaceResidues;
	
	public InterfaceResiduesDataRetrievedEvent(HashMap<Integer, List<ResidueBurial>> interfaceResidues)
	{
	 ...
	 */
	public HashMap<Integer, List<ResidueBurial>> getInterfaceResidues() {

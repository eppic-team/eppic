					...
					if(ApplicationContext.getSelectedAssemblyId() == -1){
						...
						for(Assembly a : assemblies){
							if(a.getId() == assemblyID){
								...
								assembly_string += "<tr><td><span class='eppic-general-info-label-new'>Stochiometry</span></td><td>&nbsp;&nbsp;<span class='eppic-general-info-label-value-new'>" + a.getStoichiometryString() + "</span></td></tr>";

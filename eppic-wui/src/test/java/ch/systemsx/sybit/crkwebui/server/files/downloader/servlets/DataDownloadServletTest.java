...
import ch.systemsx.sybit.crkwebui.shared.model.ResidueInfo;
...
public class DataDownloadServletTest {
	...
	ResidueInfo resInfo = new ResidueInfo();
	ResidueInfo resInfo2 = new ResidueInfo();
	ResidueBurial residue = new ResidueBurial();
	residue.setResidueInfo(resInfo);
	residue.setUid(1);	
	residue.setAsa(3.33);
	residue.setBsa(4.44);
	residue.getResidueInfo().setEntropyScore(5.55);
	residue.setRegion((short)3);
	residue.getResidueInfo().setResidueNumber(1);
	residue.getResidueInfo().setResidueType("ALA");
	residue.setSide(false);
	residues.add(residue);
	ResidueBurial residue2 = new ResidueBurial();
	residue2.setResidueInfo(resInfo2);
	residue2.setUid(2);	
	residue2.setAsa(3.33);
	residue2.setBsa(4.44);
	residue2.getResidueInfo().setEntropyScore(5.55);
	residue2.setRegion((short)3);
	residue2.getResidueInfo().setResidueNumber(17);
	residue2.getResidueInfo().setResidueType("SER");
